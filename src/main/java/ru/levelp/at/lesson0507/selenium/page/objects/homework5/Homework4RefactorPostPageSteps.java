package ru.levelp.at.lesson0507.selenium.page.objects.homework5;
...
public class Homework4RefactorPostPageSteps extends Homework4RefactorBasePageSteps {

    protected WebDriver driver;

    public Homework4RefactorPostPageSteps(WebDriver driver) {
        super(driver);
